...
Base.@kwdef mutable struct Args
    ...
    infotime::Float64 = 1 	     ## report every `infotime` epochs
    checktime::Int = 5        ## Save the model every `checktime` epochs. Set to 0 for no checkpoints.
    tblogger::Bool = true      ## log training with tensorboard
    savepath = "D:/New folder (3)" 
end
